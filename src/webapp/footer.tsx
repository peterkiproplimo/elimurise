...
const FooterComponent = () => {   
  ...
  return (
    <div className="bg-primary">
      <div className="grid mt-10 xl:mx-auto  max-w-[1500px] overflow-hidden sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 lg:divide-y-0 xl:grid-cols-2">
        <div className="group p-10 pl-5 xl:ml-10 dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
          ...
          <div className="text-white flex gap-5 xl:mt-8">
            ...
            <Link to="/cookie-policy" className="xl:px-3 xl:py-3 hover:text-blue-800 hover:scale-105 xl:text-lg">
              Cookie Policy
            </Link>
          </div>
        </div>
      ...
      <div className="border-b border-white xl:mx-auto max-w-[1500px] w-full mt-8"></div>
      
      <div className="xl:mx-auto  max-w-[1500px] flex justify-between">
