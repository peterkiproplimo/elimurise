...
const NavbarMenu = () => {
  ...
  return (
    <>
      ...
      <div className="flex xl:mx-auto xl:w-[80%] justify-between items-center w-full px-4 lg:px-10  p-2 box">
        <div className="icon ">
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 z-20">
              <div className="fixed left-0 top-0 bottom-0 bg-white shadow-lg w-80 p-5 transform transition-all duration-300 ease-in-out z-30">
                ...
                <div className=" mb-4 ">
                  ...
                  >
                    <img src={lock} alt="Demo Icon" className="w-6 h-6 mr-2" />{" "}
                    Login
                  </Link>
                  <Link
                    to="/register"
                    className="block pl-2 text-lg  hover:text-blue-800 hover:scale-105 text-primary flex items-center"
                  >
                    <img src={user} alt="Demo Icon" className="w-6 h-6 mr-2" />{" "}
                    Create Account
                  </Link>
                  <Link
                    to="/contact"
