...
const Home = () => {
  ...
  return (
    <>
      <div className="homeContainer  h-100vh ">
        ...
        <div className="grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl border border-gray-100 text-gray-600 dark:border-gray-700 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 lg:divide-y-0 xl:grid-cols-2">
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            ...
            <div className="mt-10">
              <h2 className="mt-5 xl:text-xl sm:text-3l mb-5">Engage. Empower. Excel.</h2>
      ...
      <div className="aboutContainer mt-2">
        <h1 className="xl:text-5xl sm:text-5xl md:text-3xl font-semibold text-center">Who are we?</h1>
        <div className=" p-4 grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl  dark:border-gray-700 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 lg:divide-y-0 xl:grid-cols-3">
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            ...
            <div className="contents">
              <h2 className="xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2 ">Our Core Values</h2>
              <ul className="mt-5 ml-5">
                <li className="xl:text-xl sm:text-xl md:text-xl">
                  <span className="font-bold">Excellence:</span> Providing highest quality and{" "}
                  <p className="mt-2"> standards in education.</p>
                </li>
                <li className="xl:text-xl sm:text-xl md:text-xl">
                  <span className="font-bold">Inclusivity:</span> Providing an all inclusive learning{" "}
                  <p className="mt-2">environment for everyone.</p>
                </li>
                <li className="xl:text-xl sm:text-xl md:text-xl">
                  <span className="font-bold">Community:</span>Building strong partnerships{" "}
                  <p className="mt-2">with teachers,learners and parents. </p>
                </li>
                <li className="xl:text-xl sm:text-xl md:text-xl">
                  <span className="font-bold">Innovation:</span> Tapping creativity and using{" "}
          ...
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            ...
            <h2 className="xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">Our Mission</h2>
            <p className="mt-5 xl:text-xl sm:text-xl md:text-xl ml-2 ">
              At Hero Learning, we pride ourselves <br/> in building and inclusive and robust <br/>learning environment that promotes <br/> critical thinking, <br/>creativity,
              communication, collaboration and <br/>life long learning.</p>
          </div>
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div className="secondArea">
              <img
            ...
            <h2 className="xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">Our Vision</h2>
            <p className="mt-5 xl:text-xl sm:text-xl md:text-xl ml-2">
              To empower every learner's talent <br/> with the skills
              and knowledge to build<br/> a successful future.
            </p>
          </div>
        </div>
      </div>
      <div className="aboutContainer mt-2">
        <h1 className="mt-5 text xl:text-5xl sm:text-3xl md:text-3xl font-bold  text-center mb-2">Why Hero Learning?</h1>
        <div className="grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl  dark:border-gray-700 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 lg:divide-y-0 xl:grid-cols-3">
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div className="secondArea">
              <img alt="ACS" className="xl:w-35 md:w-10 xl:w-auto" src={pic} />
            </div>
            <h2 className="text xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">Innovative CBC Approach: </h2>
            <p className="mt-5 text xl:text-xl sm:text-xl md:text-xl ml-2">Our digital assessment tool is <br/>designed for meeting the various<br/>
        needs of each learner and <br/>
           promoting a deeper understanding<br/>of subjects.</p>
          </div>

          <div  className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10" >
            <div className="secondArea">
              <img alt="ACS" className="xl:w-35 md:w-10 xl:w-auto" src={pic2} />
            </div>
            <h2 className="text xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">Technology Integration: </h2>
            <p className="mt-5 ml-2 text xl:text-xl sm:text-xl md:text-xl ">Using cutting-edge technology 
          we enhance the experience of<br/> teachers, learners and parents, <br/>
          ...
          <div  className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            ...
            <h2 className="text xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">Experienced Educators: </h2>
            <p className="mt-5 ml-2 text xl:text-xl sm:text-xl md:text-xl">Our passionate team of educators<br/>
            is committed to nurturing the <br/>potential of every student, ensuring<br/>
            they thrive. </p>
          </div>
        </div>
      </div>
      <div className="service mt-2">
        <h1 className = "mt-5 text xl:text-5xl sm:text-3xl md:text-3xl font-bold  text-center mb-5">What can you do with our system?</h1>
        <div className="grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl border border-gray-100 text-center dark:border-gray-700 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 lg:divide-y-0 xl:grid-cols-3">
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            ...
            <h2 className="text xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2 ">Parents</h2>
            <p className="mt-5 ml-2 text xl:text-xl sm:text-xl md:text-xl  "> Our system gives you <br/>
           the ability to assess the <br/>
           learner in real time, <br/>
          allowing one to keep <br/>
          proper track of progress.</p>
          </div>
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div className="flex justify-center items-center">
              <img alt="ACS" className="xl:w-35 md:w-10 xl:w-auto" src={cap} />
            </div>
            <h2 className="text xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">School</h2>
            <p className="mt-5 ml-2 text xl:text-xl sm:text-xl md:text-xl">Our system gives you <br/>
           the ability to monitor the <br/> performance<br/>of learners and provides <br/>the option for <br/>open communication<br/>
           with the parents.</p>
          </div>
          <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div className="flex justify-center items-center">
            ...
            <h2 className="text xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">Teachers</h2>
            <p className="mt-5 ml-2 text xl:text-xl sm:text-xl md:text-xl">Our system gives you <br/>
            the ability to properly assess<br/> and tap into each child's <br/> understanding <br/>
           of the sub-strands</p>
          </div>
        </div>
      </div>
      <div className="customers">
        <h1 className="mt-5 text xl:text-5xl sm:text-3xl md:text-3xl font-bold  text-center ">Impact:</h1>
        <h1 className="mt-5 text xl:text-4xl sm:text-3xl md:text-3xl font-bold  text-center mb-5">Transforming Lives Through Education</h1>
          ...
          <div className="flex  justify-center  group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div className="area">
              <img alt="ACS" className="xl:w-35 md:w-10 xl:w-auto" src={jane} />
            </div>
            <div className="m-2">
              <h2 className="text xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">Jane Doe</h2>
              <p className="xl:text-2xl sm:text-2xl md:text-2xl italic ">
                <i> Parent, Nairobi</i>
              </p>
              <p className="  text xl:text-xl sm:text-xl md:text-xl">"Hero Learning has been <br/>
            a game changer for my <br/>child. The CBC approach <br/>has truly made a difference <br/>
          ...
          <div className="flex group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            ...
            <div className="m-2">
              <h2 className="text xl:text-3xl sm:text-3xl md:text-3xl font-bold ml-2">John Doe</h2>
              <p className="xl:text-2xl sm:text-2xl md:text-2xl italic ">
                <i> Parent, Nairobi</i>
              </p>
              <p className="  text xl:text-xl sm:text-xl md:text-xl">"Hero Learning has been <br/>
      ...
      <div className="price mt-5 ">
        <h1 className="mt-5 text xl:text-5xl sm:text-3xl md:text-3xl font-bold  text-center">How Much Will it Cost You?</h1>
        <h2 className="text xl:text-xl sm:text-xl md:text-xl text-center">Please select a pricing plan that works for you</h2>
