    ...
    <>
      <div
        className={clsx([
          ...
          props.layout == "top-menu" && "dark:md:from-darkmode-800 topbar",
          // Replace the following classes to set the background color to white
          // "before:content-[''] before:absolute before:h-[65px] before:inset-0 before:top-0 before:mx-7 before:bg-white before:mt-3 before:rounded-xl before:hidden before:md:block before:dark:bg-white",
          // "after:content-[''] after:absolute after:inset-0 after:h-[65px] after:mx-3 after:bg-white after:mt-5 after:rounded-xl after:shadow-md after:hidden after:md:block after:dark:bg-white
        ])}
      >
