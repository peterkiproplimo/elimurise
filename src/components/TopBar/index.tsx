...
function Main(props: { layout?: "side-menu" | "simple-menu" | "top-menu" }) {
  ...
  return (
    <>
      <div
        className={clsx([
          "h-[50px] md:h-[65px] z-[51] border-b border-white/[0.08]   md:border-b-0 relative md:fixed md:inset-x-0 md:top-0 sm:px-8 md:px-10 md:pt-5 md:bg-gradient-to-b md:from-slate-100 md:to-transparent dark:md:from-darkmode-700",
          props.layout == "top-menu" && "dark:md:from-darkmode-800",
          "before:content-[''] before:absolute before:h-[60px] before:inset-0 before:top-0 before:mx-5 before:bg-primary/30  before:rounded-xl before:hidden before:md:block before:dark:bg-darkmode-600/30",
          "after:content-[''] after:absolute after:inset-0 after:h-[65px] after:bg-primary  after:rounded-xl after:shadow-sm after:hidden after:md:block after:dark:bg-darkmode-600",
        ])}
      >
