    ...
    <>
      <div
        className={clsx([
          ...
          "before:content-[''] before:absolute before:h-[65px] before:inset-0 before:top-0 before:mx-7 before:bg-primary/30 before:mt-2 before:rounded-xl before:hidden before:md:block before:dark:bg-darkmode-900/30",
