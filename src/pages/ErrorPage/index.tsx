        ...
        <div className="container">
          ...
          <div className="flex flex-col items-center justify-center h-screen text-center error-page lg:flex-row lg:text-left">
            ...
            <div className="mt-10 text-white lg:mt-0">
              ...
              <div className="mt-5 text-xl font-medium  lg:text-3xl">
                Oops. This page has gone missing.
              </div>
              <div className="mt-3 text-lg ">
                You may have mistyped the address or the page may have moved.
              </div>
              <Button className="px-4 py-3 mt-10 text-white border-white  dark:border-darkmode-400 dark:text-slate-200">
                Back to Home
              </Button>
            </div>
          </div>
