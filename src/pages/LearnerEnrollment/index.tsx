      ...
      {dialog ? (
        ...
        <div className="col-span-12 sm:col-span-3">
            ...
            <div className="flex mt-4  ">
              <button className="border items-center justify-center shadow-sm rounded-md font-medium cursor-pointer  bg-primary border-primary text-white dark:border-primary px-10 py-1 mr-2">Search</button>
       </div>
