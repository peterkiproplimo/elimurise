  ...
  const onSubmit = async (event: React.ChangeEvent<HTMLFormElement>) => {
    ...
    if (result && !loading) {
      ...
      try {
        ...
        console.log(data),
          await ApiService.createFAQ(data.question, data.answer);
        getFAQ();
        await reset();
        isLoading(false);
        setDialog(false);
      ...
      <div className="grid grid-cols-12 gap-6 mt-5">
                  ...
                  <Table.Td className="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
                    <div
                      className={clsx([
                        ...
                        { "text-success": FAQ.approval_status },
                        { "text-danger": !FAQ.approval_status },
                      ])}
                    >
                      <Lucide
                        icon={FAQ.approval_status ? "CheckSquare" : "XSquare"}
                        className="w-4 h-4 mr-2"
                      />
                      {FAQ.approval_status ? "Active" : "Inactive"}
                    </div>
                  </Table.Td>
                    ...
                    <div className="flex items-center justify-center">
                      <Menu>
                        ...
                        <Menu.Items className="w-40">
                          ...
                          <Menu.Item
                            onClick={() => {
                              setUserId(FAQ.id), setConfirmDelete(true);
                            }}
                          >
        ...
        <div className="flex flex-wrap items-center col-span-12 intro-y sm:flex-row sm:flex-nowrap">
          <Pagination className="w-full sm:w-auto sm:mr-auto">
            <Pagination.Link onClick={() => (setPage(previous_page), getFAQ())}>
      ...
      >
        <Dialog.Panel>
          <form className="validate-form" onSubmit={onSubmit}>
            <Dialog.Title>
              <h2 className="mr-auto text-base font-medium">FAQ</h2>
              <a
                onClick={(event: React.MouseEvent) => {
                  event.preventDefault();
                  setDialog(false);
            ...
            <Dialog.Description className="grid grid-cols-12 gap-4 gap-y-3">
              <div className="col-span-12 sm:col-span-6">
                <FormLabel htmlFor="modal-form-1">Question</FormLabel>
                <FormInput
                  {...register("question")}
                  type="text"
                  name="question"
