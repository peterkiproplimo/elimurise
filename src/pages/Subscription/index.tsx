...
function Users(props:any) {
  ...
  const handlePayment = async () => {
    ...
    const data ={name:school,numberOfLearners:noOfLearners,packageId:Package._id}
    if (!loading) {
      isLoading(true);
      try {
  ...
  return (
    <>
       ...
       <form className="validate-form" >
        ...
        <h3 className=" text-2xl font-bold intro-x">You are about to subscribe to {Package.name}</h3>
          ...
          <div className="col-span-12 sm:col-span-12 mt-5">
            <FormLabel htmlFor="modal-form-1" className="font-bold">Number of Learners</FormLabel>
            <FormInput
              {...register("numberOfLearners")}
              type="text"
              onChange={(e:any)=>{setNumberOfLearners(e.target.value)}}
      ...
      {!paymentSuccess ? (
        <div className="  p-5 mt-10 text-center  ">
          ...
          <div className="mt-10">
           <h2 className="col-span-12 sm:col-span-6 text-3xl "> KSH: 
           {formatCurrency(Number(noOfLearners)*Number(Package.pricePerLearner))}
