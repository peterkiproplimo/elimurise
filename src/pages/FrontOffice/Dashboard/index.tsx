        ...
        loading ? (
          ...
          <div className="col-span-12 mt-2 p-2 sm:p-4">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 mt-4 sm:mt-6">
                <div className="col-span-1">
                  <div
                    className={clsx(["relative zoom-in"])}
                    onClick={(event) => {
                      event.preventDefault();
                      navigate("/home/visitors");
                    }}
                  >
                    <div className="p-4 sm:p-5 box">
                      <div className="flex flex-wrap items-center">
                        <Lucide
                          icon="Users"
                          className="w-6 h-6 sm:w-7 sm:h-7 text-info mr-2"
                        />
                        <div className="ml-auto">
                          <Tippy
                            as="div"
                  ...
                  >
                    <div className="p-4 sm:p-5 box">
                      <div className="flex flex-wrap items-center">
                        <Lucide
                          icon="MessageSquare"
                          className="w-6 h-6 sm:w-7 sm:h-7 text-danger mr-2"
                        />
                        <div className="ml-auto">
                          <Tippy
                            as="div"
                    ...
                    <div className="p-4 sm:p-5 box">
                      <div className="flex flex-wrap items-center">
                        ...
                        <div className="ml-auto">
                          <Tippy
                            as="div"
                            className="cursor-pointer bg-warning py-1 sm:py-[3px] flex rounded-full text-white text-xs pl-2 pr-1 items-center font-medium"
                            content="Total Enquiries"
                          >
                            <Lucide
                              icon="ChevronUp"
                              className="w-3 h-3 sm:w-4 sm:h-4 ml-0.5"
                ...
                <div className="col-span-1">
                  <div
                    ...
                    onClick={(event) => {
                      event.preventDefault();
                      navigate("/home/onlineapplications");
                    }}
                  >
                    <div className="p-4 sm:p-5 box">
                      <div className="flex flex-wrap items-center">
                        <Lucide
                          icon="FileText"
                          className="w-6 h-6 sm:w-7 sm:h-7 text-success mr-2"
                        />
                        <div className="ml-auto">
                          <Tippy
                            as="div"
                            className="cursor-pointer bg-success py-1 sm:py-[3px] flex rounded-full text-white text-xs pl-2 pr-1 items-center font-medium"
                            content="Total Online Applicants"
                          >
                            <Lucide
                              icon="ChevronUp"
                              className="w-3 h-3 sm:w-4 sm:h-4 ml-0.5"
                      ...
                      <div className="mt-4 sm:mt-6 text-2xl sm:text-3xl font-medium leading-8">
                        {dashboards.totalOnlineApplicants || 0}
                      </div>
                      <div className="mt-1 text-sm sm:text-base text-slate-500">
                        Total Online Applicants
                      </div>
                    </div>
                  </div>
                </div>
