          ...
          <div className="px-5 pt-5 mt-5 flex flex-col pb-5 -mx-5 border-b lg:flex-row border-slate-200/60 dark:border-darkmode-400">
            <div className="flex items-center justify-center flex-1 px-5 lg:justify-start">
              <div className="relative flex-none w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 image-fit">
                <img alt="" className="rounded-full" src={user.photo} />
          ...
          <div className="p-5">
            <div className="grid grid-cols-12 gap-x-5">
              <div className="col-span-12 xl:col-span-6">
                ...
                <div className="mt-3">
                  <FormLabel htmlFor="update-profile-form-9">Country</FormLabel>
                  <FormInput
              ...
              <div className="col-span-12 xl:col-span-6">
                <div className="mt-3 xl:mt-0">
                  <FormLabel htmlFor="update-profile-form-10">Gender</FormLabel>
                  <FormInput
                ...
                <div className="mt-3">
                  <FormLabel htmlFor="update-profile-form-11">County</FormLabel>
                  <FormInput
